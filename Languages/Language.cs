...
namespace Languages
{
    ...
    public sealed partial class Language : IEquatable<Language>
    {
        ...
        public Language(string name, string part3, string part2B, string part2, string part1, LanguageType type, LanguageScope scope)
        {
        ...
        public static Language FromPart1(string code)
        {
            if (code is null)
        ...
        /// <returns>The specified <see cref="Language"/>, or <c>null</c> if none was found.</returns>
        /// <exception cref="ArgumentNullException">If <paramref name="code"/> is <c>null</c>.</exception>
        public static Language FromPart2(string code)
        {
            if (code is null)
                throw new ArgumentNullException(nameof(code), "Language code cannot be null.");
            if (code.Length != 3)
            ...
            foreach (var language in database)
            {
                if (language.Part2 is null)
                    continue;
                if (language.Part2B.Equals(code, StringComparison.OrdinalIgnoreCase) || language.Part2.Equals(code, StringComparison.OrdinalIgnoreCase))
                    return language;
            }
            return null;
        }
        ...
        /// <returns>The specified <see cref="Language"/>, or <c>null</c> if none was found.</returns>
        /// <exception cref="ArgumentNullException">If <paramref name="code"/> is <c>null</c>.</exception>
        public static Language FromPart3(string code)
        {
            if (code is null)
                throw new ArgumentNullException(nameof(code), "Language code cannot be null.");
            if (code.Length != 3)
        ...
        public static IEnumerable<Language> FromName(string name, bool ignoreCase)
        {
            if (name is null)
